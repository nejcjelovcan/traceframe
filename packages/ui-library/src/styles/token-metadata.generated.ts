...
export const TOKEN_METADATA = {
  palettes: {
    ...
    "accent-1": {
      description: "",
      usage: "Categorical data visualization, visual distinction",
      shades: [
        50,
        100,
        200,
    ...
    secondary: {
      description: "",
      usage: "Secondary buttons, accents, alternative actions",
      shades: [
        50,
        100,
        200,
  ...
  semantic: {
    ...
    interactive: {
      ...
      variants: {
        ...
        "destructive-border": "Border color for destructive buttons and outlined destructive elements",
  ...
  theme: {
    fontFamily: {
      sans: {
        value: "'IBM Plex Sans Variable', 'IBM Plex Sans', Inter, system-ui, sans-serif",
        description: "Typography"
      },
      mono: {
        value: "'IBM Plex Mono', 'JetBrains Mono', Menlo, monospace",
    ...
    shadow: {
      ...
      md: {
        value: "0 2px 4px -1px color-mix(in srgb, var(--token-shadow-color) 5%, transparent),\n      0 1px 2px -1px color-mix(in srgb, var(--token-shadow-color) 3%, transparent)",
        description: ""
      },
      lg: {
        value: "0 6px 12px -3px color-mix(in srgb, var(--token-shadow-color) 7%, transparent),\n      0 3px 6px -3px color-mix(in srgb, var(--token-shadow-color) 4%, transparent)",
        description: ""
      },
      interactive: {
      ...
      "interactive-hover": {
        value: "0 4px 8px -1px color-mix(in srgb, var(--token-shadow-color) 6%, transparent),\n      0 2px 4px -1px color-mix(in srgb, var(--token-shadow-color) 4%, transparent)",
        description: ""
      },
      "interactive-pressed": {
      ...
      "highlight-hover": {
        value: "0 6px 12px -2px color-mix(in srgb, var(--token-shadow-color) 8%, transparent),\n      0 3px 6px -2px color-mix(in srgb, var(--token-shadow-color) 5%, transparent)",
        description: ""
      },
      "highlight-pressed": {
        value: "0 1px 3px 0\n      color-mix(in srgb, var(--token-shadow-color) 4%, transparent)",
      ...
      color: {
        value: "var(--palette-neutral-950)",
        description: "Primary shadow color for elevation effects"
      }
    },
    spacing: {
      "2xs": {
    ...
    gradient: {
      ...
      "accent-1-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-accent-1-50),\n      var(--palette-accent-1-100)\n    )",
      ...
      "accent-2-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-accent-2-50),\n      var(--palette-accent-2-100)\n    )",
      ...
      "accent-3-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-accent-3-50),\n      var(--palette-accent-3-100)\n    )",
      ...
      "accent-4-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-accent-4-50),\n      var(--palette-accent-4-100)\n    )",
      ...
      "accent-5-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-accent-5-50),\n      var(--palette-accent-5-100)\n    )",
      ...
      "status-success-light": {
        value: "linear-gradient(\n      180deg,\n      var(--palette-success-50),\n      var(--palette-success-100)\n    )",
