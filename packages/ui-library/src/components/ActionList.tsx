    ...
    variants: {
      variant: {
        default: [
          ...
          'aria-selected:bg-interactive-primary aria-selected:text-interactive-primary-foreground',
      ...
      density: {
        ...
        comfortable: 'py-sm px-md text-base min-h-size-md',
        spacious: 'py-md px-base text-base min-h-size-lg',
      },
    },
    defaultVariants: {
      variant: 'default',
