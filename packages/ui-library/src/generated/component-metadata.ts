...
export const COMPONENT_METADATA: Record<string, ComponentMeta> = {
  ...
  Flex: {
    ...
    usage:
      'Use for linear layouts like form fields, button groups, navigation items, or any content that flows in a single direction. Prefer Flex over manual flex utilities for consistency.',
    accessibility: [
